...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    companion object {
        ...
        CREATE TABLE ${PostColumns.TABLE} (
            ...
            ${PostColumns.COLUMN_COMMENTED_BY_ME} BOOLEAN NOT NULL DEFAULT 0
    ...
    object PostColumns {
        ...
        const val COLUMN_COMMENTED_BY_ME = "commentedByMe"
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                comments = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_COMMENTS)),
                ...
                commentedByMe = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_COMMENTED_BY_ME)) != 0
            )
        }
    }
}
